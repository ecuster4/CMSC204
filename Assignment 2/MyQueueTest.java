...
public class MyQueueTest {
	...
	public void setUp() throws Exception {
		...
		doubleQ.enqueue(44.0);
		doubleQ.enqueue(121.0);
	}
	...
	{
		try {
			assertEquals(20.0, doubleQ.dequeue(),.0);
			assertEquals(44.0, doubleQ.dequeue(),.0);
			assertEquals(121.0, doubleQ.dequeue(),.0);
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleQ.dequeue(); 
			assertTrue(false, "This should have caused an QueueUnderflowException");
		}
	...
	public void testEnqueueStudent() 
	{
		try {
			...
			assertEquals(true, doubleQ.enqueue(65.0));
			assertEquals(5, doubleQ.size());
			
			doubleQ.enqueue(66.0); 
			doubleQ.enqueue(23.33);
			assertTrue(false, "This should have caused an QueueOverflowException");
		}
		catch (QueueOverflowException e){
			assertTrue(true, "This should have caused an QueueOverflowException");
	...
	{
		String stackTemp = doubleQ.toString();
		assertEquals(stackTemp,"20.044.0121.0");
		doubleQ.enqueue(59.0);
		assertEquals(doubleQ.toString(),"20.044.0121.059.0");
	}
