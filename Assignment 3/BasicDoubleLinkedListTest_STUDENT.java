...
public class BasicDoubleLinkedListTest_STUDENT {
	...
	public Car a=new Car("Hyundai", "Sonatta", 2002);
	public Car b=new Car("Toyta", "Prius", 2002);
	public Car c=new Car("Lambo", "Adventador", 2002);
	public Car d=new Car("Prosche", "911", 2002);
	public Car e=new Car("Honda", "Cafe Racer", 2002);
	public Car f=new Car("Chrysler", "Fastr", 2002);
	...
	public void testAddToEnd() {
		assertEquals("Fruit", linkedString.getLast());
	...
	public void testIteratorSuccessfulNext() {
		...
		assertEquals("Fruit", iterator.next());
		assertEquals(true, iterator.hasNext());
	...
	public void testRetrieveFirstElement() {
		...
		assertEquals("Fruit",linkedString.getFirst());
